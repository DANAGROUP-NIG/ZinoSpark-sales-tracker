...
export function WalletOverview({ balance, totalCustomerBalanceUSD, pendingExchangesUSD = 0 }: WalletOverviewProps) {
  const AED_RATE = 3.67;
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{showUsd ? `$${balance.toLocaleString()}` : <span className="tracking-widest">*****</span>}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{showUsd ? `$${totalCustomerBalanceUSD.toLocaleString()}` : <span className="tracking-widest">*****</span>}</div>
